          ...
          tracks.map((track, index) => (
            <div
              ...
              className={`p-4 rounded-lg flex items-center justify-between transition-all ${
                currentTrack?.file === track.file ? 'bg-green-900 border-l-4 border-green-400' : 'bg-gray-800 hover:bg-gray-700'
              }`}
            >
              <div>
              ...
              <div className="flex items-center space-x-4">
                ...
                {track.articleId && (
                    <a
                      ...
                      className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-500 transition-colors text-sm"
                    >
                      Read Analysis
                    </a>
                )}
                <button
                  ...
                  className="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-500 transition-colors disabled:bg-gray-600 w-28 text-sm"
